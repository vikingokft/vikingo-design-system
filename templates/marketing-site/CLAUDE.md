# Project Rules for Claude Code — Marketing / Landing Page

> **Audience:** Claude Code (and any AI agent) working in a marketing-site / landing-page consumer project that uses `@vikingo/ui`.
...
This project uses the **Vikingo Design System** (`@vikingo/ui`) for a **marketing or landing-page site**. Canonical references:
