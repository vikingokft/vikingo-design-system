# Project Rules for Claude Code — Next.js App Router

> **Audience:** Claude Code (and any AI agent) working in a Next.js consumer project that uses `@vikingo/ui`.
...
This project uses the **Vikingo Design System** (`@vikingo/ui`) with **Next.js App Router**. Canonical references:
