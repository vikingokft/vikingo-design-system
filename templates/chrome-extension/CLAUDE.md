# Project Rules for Claude Code — Chrome Extension (Manifest v3)

> **Audience:** Claude Code (and any AI agent) working in a Chrome Extension consumer project that uses `@vikingo/ui`.
> **Use:** copy this file into your project root as `CLAUDE.md`. For other platforms, see [templates/README.md](https://github.com/vikingokft/vikingo-design-system/blob/main/templates/README.md).

This project uses the **Vikingo Design System** (`@vikingo/ui`) inside a **Manifest v3 Chrome Extension**. Hard-won lessons from real extensions are baked in below; the canonical references are:

- [docs/components.md](https://github.com/vikingokft/vikingo-design-system/blob/main/docs/components.md), [docs/styling.md](https://github.com/vikingokft/vikingo-design-system/blob/main/docs/styling.md), [docs/patterns.md](https://github.com/vikingokft/vikingo-design-system/blob/main/docs/patterns.md)
- [Storybook (live)](https://vikingo-storybook.vercel.app)
